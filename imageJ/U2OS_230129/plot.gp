...
########## U2OS ##########
ROOT = "/Users/nakaokahidenori/Documents/Publications/2023_Hara_CST/RAD51/U2OS_230129/"
...
"" using ($3<2000 && strcol(6) eq "Ctrl_H2O2" ? (2) : 1/0):5 with points pt 6 ps 2 lc rgb ASAGI,\
"" using ($3<2000 && strcol(6) eq "shSTN1" ? (3) : 1/0):5 with points pt 6 ps 2 lc rgb GINNEZUMI,\
"" using ($3<2000 && strcol(6) eq "shSTN1_H2O2" ? (4) : 1/0):5 with points pt 6 ps 2 lc rgb ASAGI
...
plot DATA using ($3>2000 && strcol(8) eq "Ctrl" ? (1) : 1/0):6 with points pt 6 ps 1 lc rgb GINNEZUMI,\
"" using ($3>2000 && strcol(8) eq "Ctrl_H2O2" ? (2) : 1/0):6 with points pt 6 ps 1 lc rgb ASAGI,\
"" using ($3>2000 && strcol(8) eq "shSTN1" ? (3) : 1/0):6 with points pt 6 ps 1 lc rgb GINNEZUMI,\
"" using ($3>2000 && strcol(8) eq "shSTN1_H2O2" ? (4) : 1/0):6 with points pt 6 ps 1 lc rgb ASAGI